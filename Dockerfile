...
RUN         apt update && apt install -y google-cloud-sdk python3 python2.7 python3-pip g++ gcc libxslt-dev libffi-dev && rm -rf /var/lib/apt/lists/*
...
RUN         cd /tmp && pipenv install --system --python 3.8
